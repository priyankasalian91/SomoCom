...
import com.aipl.store.repository.ArticleSpecification;
...
/*	@Override
	public Page<Article> findArticlesByCategories(Pageable pageable, List<String> categories)
	{
	...
	@Override
	@CacheEvict(value = { "sizes", "categories", "brands", "articleimages" }, allEntries = true)
	...
	@Override
	@Cacheable("articleimages")
	public List<String> getAllArticleImages() {
		return articleRepository.findAllArticleImages();
	}
}
